...
Программа для консоли в :l:`Linux`, которая имитирует поток бинарных цифр из
фильма матрица. Очень эффектно выглядит, рекомендую попробовать!

.. image:: /_static/2013/matrix_code.png
   :align: center
...
.. code-block:: python
   ...
   original code adapted from juancarlospaco:
     1. http://ubuntuforums.org/showpost.php?p=10306676

   Inspired by the movie: The Matrix
     1. Corey Goldberg (2013)
