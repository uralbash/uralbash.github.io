...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        ...
        <title>Pygments &mdash; Ural penguins</title>
...
<h1>Pygments<a class="headerlink" href="#pygments" title="Ссылка на этот заголовок">¶</a></h1>
...
<tr class="field-even field"><th class="field-name">license:</th><td class="field-body">BSD, see LICENSE for details.</td>
  ...
  <div class="section">
    ...
    <script type="text/javascript">
        ...
        var disqus_identifier = '/.env/lib64/python3.8/site-packages/Pygments-2.2.0.dist-info/DESCRIPTION/';
        var disqus_title = 'Pygments';
