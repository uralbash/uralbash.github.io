...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        ...
        <title>Werkzeug &mdash; Ural penguins</title>
...
<h1>Werkzeug<a class="headerlink" href="#werkzeug" title="Ссылка на этот заголовок">¶</a></h1>
...
<h2>Features<a class="headerlink" href="#features" title="Ссылка на этот заголовок">¶</a></h2>
<ul class="simple">
...
<h2>Development Version<a class="headerlink" href="#development-version" title="Ссылка на этот заголовок">¶</a></h2>
<p>The Werkzeug development version can be installed by cloning the git
repository from <a class="reference external" href="http://github.com/pallets/werkzeug">github</a>:</p>
<div class="highlight-default"><div class="highlight"><pre><span></span><span class="n">git</span> <span class="n">clone</span> <span class="n">git</span><span class="nd">@github</span><span class="o">.</span><span class="n">com</span><span class="p">:</span><span class="n">pallets</span><span class="o">/</span><span class="n">werkzeug</span><span class="o">.</span><span class="n">git</span>
</pre></div>
</div>
</div>
</div>
  ...
  <div class="section">
    ...
    <script type="text/javascript">
        ...
        var disqus_identifier = '/.env/lib64/python3.8/site-packages/Werkzeug-0.12.1.dist-info/DESCRIPTION/';
        var disqus_title = 'Werkzeug';
