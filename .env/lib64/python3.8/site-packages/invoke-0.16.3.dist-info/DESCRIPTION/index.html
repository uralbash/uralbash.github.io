...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        ...
        <title>&lt;no title&gt; &mdash; Ural penguins</title>
...
<body>
  ...
  <p>To find out what&#8217;s new in this version of Invoke, please see <a class="reference external" href="http://pyinvoke.org/changelog.html#0.16.3">the changelog</a>.</p>
...
<span class="k">def</span> <span class="nf">clean</span><span class="p">(</span><span class="n">ctx</span><span class="p">,</span> <span class="n">docs</span><span class="o">=</span><span class="bp">False</span><span class="p">,</span> <span class="n">bytecode</span><span class="o">=</span><span class="bp">False</span><span class="p">,</span> <span class="n">extra</span><span class="o">=</span><span class="s1">&#39;&#39;</span><span class="p">):</span>
    ...
    <span class="k">for</span> <span class="n">pattern</span> <span class="ow">in</span> <span class="n">patterns</span><span class="p">:</span>
        <span class="n">ctx</span><span class="o">.</span><span class="n">run</span><span class="p">(</span><span class="s2">&quot;rm -rf {0}&quot;</span><span class="o">.</span><span class="n">format</span><span class="p">(</span><span class="n">pattern</span><span class="p">))</span>
...
<span class="pre">git+https://github.com/pyinvoke/invoke#egg=invoke</span></code>.</p>
  ...
  <div class="section">
    ...
    <script type="text/javascript">
        ...
        var disqus_identifier = '/.env/lib64/python3.8/site-packages/invoke-0.16.3.dist-info/DESCRIPTION/';
        var disqus_title = '&amp;lt;no title&amp;gt;';
